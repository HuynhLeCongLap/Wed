...
<nav class="bottom-nav" aria-label="Menu chinh">
    <a href="index.php"><i class="fa-solid fa-house icon"></i><span>Trang chủ</span></a>
    <a href="index.php"><i class="fa-solid fa-mobile-screen icon"></i><span>Sản phẩm</span></a>
    <a href="pages/cart.php"><i class="fa-solid fa-cart-shopping icon"></i><span>Giỏ hàng</span></a>
    <a href="<?= isset($_SESSION['user_id']) ? 'pages/profile.php' : 'pages/login.php' ?>"><i class="fa-solid fa-user icon"></i><span><?= isset($_SESSION['user_id']) ? 'Tài khoản' : 'Đăng nhập' ?></span></a>
</nav>
</body>
