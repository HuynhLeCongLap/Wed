...
try {
    ...
    // 5c. Ghi lịch sử trạng thái hủy
    $stmtT = mysqli_prepare($conn,
        "INSERT INTO order_tracking (MaHoaDon, TrangThai, GhiChu) VALUES (?, 'Đã hủy', 'Khách hàng tự hủy đơn')");
    if ($stmtT) {
    ...
    // 5d. Trừ lại TongTienThanhToan của khách hàng
